...
html_sidebars = {'**': ['globaltoc.html', 'https://raw.githubusercontent.com/Vir0z4/svrp/main/docs/sidebar.rst']}
...
html_theme_options: Dict[str, Any] = {
    ...
    "source_repository": "https://github.com/Vir0z4/svrp",
    "source_branch": "main",
