...
class SnyPatcher(QtWidgets.QDialog):
    def __init__(self, main_window):
        ...
        self.warning_label = QLabel(
            "Please make sure that the path to input and output directory does\nnot contain spaces!", self)
    ...
    def patch(self):
        ...
        if not input_path or not output_path or not file_name:
            ...
            QtWidgets.QMessageBox.warning(self, 'Error', "Your input path contains spaces!")
        elif has_spaces(output_path):
            QtWidgets.QMessageBox.warning(self, 'Error', "Your output path contains spaces!")
        else:
