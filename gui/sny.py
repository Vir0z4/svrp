...
from PyQt6.QtWidgets import QLabel, QLineEdit, QPushButton, QFileDialog, QMessageBox
...
class SnyPatcher(QtWidgets.QDialog):
    def __init__(self, main_window):
        ...
        self.warning_label = QLabel("This version of SVRP is only compatible with Windows Vista, 7\nand most 8 recoveries!", self)
    ...
    def patch(self):
        ...
        if not input_path or not output_path or not file_name:
            ...
            batch_file = r"C:\SVRP\snypatcher.bat"
